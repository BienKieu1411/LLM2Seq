...
T5Gemma still achieves substantially higher ROUGE-2 and ROUGE-L scores.
...
On WikiLingua, the Qwen variant is close to T5Gemma on ROUGE-1 while producing shorter summaries, which supports the design but does not show that LLM2Seq is better than standard encoder-decoder baselines.
