...
Supports 4 configurations via config flags:
    1. Baseline:   use_mtp=False, use_distillation=False
    2. KD-only:    use_mtp=False, use_distillation=True
    3. MTP-only:   use_mtp=True,  use_distillation=False
    4. KD + MTP:   use_mtp=True,  use_distillation=True
"""
