...
LOCAL_PHASE2_DIR="runs/llm2seq_llm2seq_phase2_lora_encoder"

PHASE3_CONFIG="${PHASE3_CONFIG:-configs/wikilingua_phase3.yaml}"
PHASE3_DIR="${PHASE3_DIR:-runs/llm2seq_llm2seq_phase3_mtp_self_distill}"
