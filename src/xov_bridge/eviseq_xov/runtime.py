...
LOGGER = logging.getLogger("eviseq_xov.runtime")
...
def train(
    ...
    *,
    ...
    try:
        ...
        model = EviSeqXOV(config).to(device=selected_device, dtype=torch.float32)
        counts = {
...
def evaluate(
    ...
    *,
    ...
    model = EviSeqXOV(inference_config).to(device_obj)
