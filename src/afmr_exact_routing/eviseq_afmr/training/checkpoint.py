...
from ..config import contextual_value_settings, exact_routing_settings
...
def architecture_spec(config: dict[str, Any]) -> dict[str, Any]:
    ...
    if arch.get("name") == "afmr_exact_routing":
        spec["exact_routing"] = {
            "mechanism": "query_conditioned_block_exact_token_read",
            **exact_routing_settings(arch),
        }
