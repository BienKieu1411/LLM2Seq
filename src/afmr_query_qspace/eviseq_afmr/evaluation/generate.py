...
def generate_greedy(
    ...
    *,
    ...
    region_keys = getattr(bridge, "region_keys", None)
    region_values = getattr(bridge, "region_values", None)
    ...
    try:
        model.decoder.prepare_cross_cache(
            ...
            **(
                {"region_keys": region_keys, "region_values": region_values, "region_mask": region_mask}
        ...
        for step in range(max_new_tokens):
            ...
            if (
                ...
                if surviving.numel() != active_rows.numel():
                    ...
                    if region_keys is not None:
                        region_keys = region_keys.index_select(0, surviving)
                        region_values = region_values.index_select(0, surviving)
