"""Two-stage full fine-tuning for LLM2Seq-v3 with contrastive warmup."""
...
LOGGER = logging.getLogger("llm2seq_v3")
...
) -> Tuple[LLM2SeqV3, Any, Any, SummarizationDataset | None, SummarizationDataset | None]:
