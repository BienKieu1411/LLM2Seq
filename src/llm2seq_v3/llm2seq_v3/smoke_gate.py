"""Fail-fast sanity gate for a completed v3 smoke run.

This gate detects broken generation, collapsed routing, and disconnected source
attention. It deliberately does not use ROUGE as a success criterion: a
