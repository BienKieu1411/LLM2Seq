"""Configuration loading and validation for decoder-only baselines."""
...
def load_config(path: str | Path) -> dict[str, Any]:
    """Load one fully materialized run config.

    The suite writes absolute data and output paths.  Standalone configs may
    use paths relative to their own YAML file, which makes the CLI independent
