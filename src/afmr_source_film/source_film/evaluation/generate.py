...
def generate_greedy(
    ...
    *,
    ...
    model.decoder.eval()
    source_controller = getattr(bridge, "controller", None)
    model.decoder.set_source_controller(source_controller)
            ...
            if (
                ...
                if surviving.numel() != active_rows.numel():
                    ...
                    if source_controller is not None:
                        source_controller = source_controller.index_select(0, surviving)
                        model.decoder.set_source_controller(source_controller)
