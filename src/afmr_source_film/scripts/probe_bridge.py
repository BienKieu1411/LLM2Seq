...
from source_film.config import load_config  # noqa: E402
from source_film.data.copy_alignment import COPY_INPUT_KEYS  # noqa: E402
from source_film.modeling.model import EviSeqAFMR  # noqa: E402
from source_film.runtime import build_loaders  # noqa: E402
from source_film.training.checkpoint import load_checkpoint  # noqa: E402
...
def run_probe(
    ...
    *,
    ...
    source_film_active = any(layer.source_film is not None for layer in model.decoder.backbone.layers)
    return {
        ...
        "source_film_active": source_film_active,
        "results": results,
    }
