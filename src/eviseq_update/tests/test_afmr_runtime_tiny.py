...
from eviseq_update.runtime import _write_resolved_config, build_loaders, evaluate
from eviseq_update.training.checkpoint import load_checkpoint
...
@pytest.mark.parametrize("grounded_copy,semantic_read", [(False, False), (True, False), (True, True)])
def test_tiny_runtime_trains_saves_best_and_streams_eval(tmp_path: Path, grounded_copy, semantic_read):
