from eviseq_update.evaluation.generate import append_jsonl, existing_ids
from eviseq_update.evaluation.metrics import summarization_metrics
...
def test_chat_prompt_is_not_penalized_as_generated_text(monkeypatch):
    ...
    from eviseq_update.evaluation import generate
...
def test_greedy_constraints_match_transformers_processors():
    import torch
    from eviseq_update.evaluation.generate import (
