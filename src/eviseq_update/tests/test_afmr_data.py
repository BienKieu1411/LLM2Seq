...
from eviseq_update.data.normalization import detokenize
...
def test_length_buckets_reduce_padding_and_resume_by_epoch():
    from eviseq_update.data.sampling import LengthBucketBatchSampler
...
def test_cli_prepare_requires_no_evidence_options(tmp_path):
    from eviseq_update.cli import main
