...
def audit_final_claim(
    ...
    return {
        "passed": passed,
        "claim": ("LLM2Seq-v4 strictly exceeds T5Gemma2-1B-1B with fewer total and deployable parameters"),
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Strictly audit V4 against the actual T5Gemma2-1B-1B artifacts.")
