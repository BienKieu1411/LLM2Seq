"""Pure-tensor tests for the V4 prospective-summary bridge."""
...
from llm2seq_v4.response_alignment import ordered_response_alignment_loss
from llm2seq_v4.training import _capture_optimizer_moments, _restore_optimizer_moments
