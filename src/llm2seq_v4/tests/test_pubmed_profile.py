"""Offline tests for the V4 PubMed preparation and 4096-token profile."""
...
from llm2seq_v4.prepare_pubmed import prepare
...
def test_pubmed_preparation_and_profile(tmp_path: Path) -> None:
    ...
    config = load_config(root / "configs/pubmed_qwen3_embedding_0_6b_psb_4096.yaml")
