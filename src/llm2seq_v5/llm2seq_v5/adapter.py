"""Identity-preserving V5 bridge with prospective summary latent planning."""
...
class ProspectiveSummaryBridge(nn.Module):
    ...
    def __init__(
        ...
        # drift, so the identity-preserving V5 path leaves it disabled by
...
# Compatibility alias for tensor-only tests and any early V5 pilot configs.
# New code and paper descriptions use the architecture's actual V5 name.
