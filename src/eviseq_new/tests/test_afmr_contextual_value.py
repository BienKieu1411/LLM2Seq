...
from eviseq_afmr.config import contextual_value_settings, load_config, validate_config
...
@pytest.mark.parametrize("mode,context", [("afmr", "true"), ("afmr", "false"), ("direct_projection", "false")])
