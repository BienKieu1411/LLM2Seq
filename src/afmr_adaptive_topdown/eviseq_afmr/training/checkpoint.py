...
def architecture_spec(config: dict[str, Any]) -> dict[str, Any]:
    ...
    spec = {
        "graph_version": "afmr_adaptive_topdown_keys",
    ...
    topdown = adaptive_topdown_settings(arch)
    if topdown["enabled"]:
        spec["adaptive_topdown"] = {
            "mechanism": "controller_weighted_regions_global_mix_topdown_keys",
            **topdown,
        }
