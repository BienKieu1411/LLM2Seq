...
def generate_greedy(
    ...
    *,
    ...
    layer_memories = getattr(bridge, "layer_memories", None)
    ...
    try:
        model.decoder.prepare_cross_cache(
            ...
            **({"layer_memories": layer_memories} if layer_memories is not None else {}),
        )
            ...
            if (
                ...
                if surviving.numel() != active_rows.numel():
                    ...
                    if layer_memories is not None:
                        layer_memories = tuple(layer.index_select(0, surviving) for layer in layer_memories)
