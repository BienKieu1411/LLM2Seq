...
from eviseq_update_v5.training import checkpoint as checkpoint_module
from eviseq_update_v5.training.checkpoint import architecture_spec, load_checkpoint, save_checkpoint
from eviseq_update_v5.training.engine import GlobalCosineScheduler, global_cosine_factor
from eviseq_update_v5.training.optimizer import _component
...
def test_parameter_group_names_cover_v51_components():
    names = {
...
def test_tiny_model_forward_and_backward_uses_no_network():
    config = load_config(ROOT / "configs" / "afmr_smoke.yaml")
    from eviseq_update_v5.runtime import build_loaders
