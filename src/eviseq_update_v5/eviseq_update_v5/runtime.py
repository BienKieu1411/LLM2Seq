...
LOGGER = logging.getLogger("eviseq_update_v5.runtime")
...
def evaluate(
    ...
    *,
    ...
    from .evaluation.provenance import ensure_evaluation_manifest, evaluation_identity, verify_checkpoint_metadata
    ...
    verify_checkpoint_metadata(checkpoint_path, config)
    LOGGER.info(
    ...
    for batch in loader:
        ...
        while pending_batches:
            ...
            try:
                ...
                left = {
                    key: value[:half].detach() if isinstance(value, torch.Tensor) else value[:half]
