...
def architecture_spec(config: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "graph_version": "eviseq_v51_value_anchor_dual_readout",
...
def load_checkpoint(
    ...
    *,
    ...
    if state.get("format_version", 1) < 2:
        raise ValueError("Checkpoint format is older than the v5.1 provenance contract")
