"""Flat source-conditioned semantic reader used by EviSeq v5.1.

The reader is deliberately small: it exposes the v2 graph exactly, keeps source
...
class SemanticReader(nn.Module):
    """Independent flat source read with the exact v2 RMS ordering."""
