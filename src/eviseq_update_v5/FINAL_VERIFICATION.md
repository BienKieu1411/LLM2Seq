# Xác minh bản thiết kế EviSeq v5.1
...
| Nguồn | Điểm mạnh đã xác nhận | Cách v5.1 giữ | Trạng thái |
|---|---|---|---|
...
| Điểm yếu | Cơ chế v5.1 | Mức khắc phục |
|---|---|---|
...
| Gate | Điều kiện |
|---|---|
| Architecture gate | Một checkpoint v5.1 dưới common EviSeq recipe có R1 `>49.626`, R2 `>21.953`, RL `>45.895` |
