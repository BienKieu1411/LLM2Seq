...
RUN_ROOT="${RUN_ROOT:-${ROOT}/runs/eviseq_update_v5/pubmed_pair_v51}"
...
from eviseq_update_v5.config import load_config, validate_config
...
if not torch.distributed.is_nccl_available():
    raise SystemExit("multi-GPU v5.1 training requires NCCL")
PY
fi
