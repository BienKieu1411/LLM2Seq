...
from grounded_summary.runtime import _write_resolved_config, build_loaders, evaluate
from grounded_summary.training.checkpoint import load_checkpoint
...
def test_tiny_runtime_trains_saves_best_and_streams_eval(tmp_path: Path, grounded_copy):
    ...
    resumed_model = AFMRModel(config)
