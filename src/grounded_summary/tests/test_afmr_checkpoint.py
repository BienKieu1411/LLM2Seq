...
def test_checkpoint_roundtrip_and_structural_guard(tmp_path):
    ...
    legacy["architecture_spec"]["graph_version"] = "afmr_content_windows_lowrank_legacy"
...
def test_architecture_spec_excludes_runtime_paths():
    ...
    assert spec["region_router"]["enabled"] is False
    assert spec["region_router"]["start_fraction"] == 0.75
