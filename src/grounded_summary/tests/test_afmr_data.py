...
from grounded_summary.data.normalization import detokenize
from grounded_summary.data.prepare import prepare_split
from grounded_summary.data.schema import CanonicalRecord
from grounded_summary.runtime import _TinyTokenizer


def test_length_buckets_reduce_padding_and_resume_by_epoch():
    from grounded_summary.data.sampling import LengthBucketBatchSampler
...
def test_cli_prepare_requires_no_evidence_options(tmp_path):
    from grounded_summary.cli import main
...
def test_source_target_records_are_accepted_with_default_afmr_fields():
