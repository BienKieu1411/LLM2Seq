...
from grounded_summary.config import load_config  # noqa: E402
from grounded_summary.modeling.model import AFMRModel  # noqa: E402
from grounded_summary.runtime import _write_resolved_config, build_loaders, evaluate  # noqa: E402
from grounded_summary.training.checkpoint import load_checkpoint  # noqa: E402
from grounded_summary.training.engine import AFMRTrainer, seed_everything  # noqa: E402
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="grounded_summary_smoke_") as directory:
