"""Minimal RelationalKey command line entry points."""
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(prog="relational_key")
    ...
    if args.command == "validate-config":
        ...
        print(f"valid RelationalKey config: {config['_meta']['config_path']}")
        return
