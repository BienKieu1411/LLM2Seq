...
def prepare_dataset(
    ...
    *,
    ...
    allow_cross_split_content = allow_cross_split_content or (
        os.getenv("ALLOW_CROSS_SPLIT_CONTENT", "").strip().lower() in _TRUE_VALUES
    )
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Prepare PubMed/ArXiv/CNNDM/WikiLingua JSONL for AFMR")
