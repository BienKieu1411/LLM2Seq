...
def _generate(
    ...
    *,
    ...
    semantic_state = getattr(bridge, "semantic_state", None)
    try:
        ...
        for step in range(max_new_tokens):
            ...
            logits, past, _ = model.decoder(
                ...
                **({"semantic_state": semantic_state} if semantic_state is not None else {}),
            )
            ...
            if (
                ...
                if surviving.numel() != active_rows.numel():
                    ...
                    if semantic_state is not None:
                        semantic_state = semantic_state.index_select(surviving)
    finally:
