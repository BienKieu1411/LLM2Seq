...
- **Architecture gate:** dưới cùng common EviSeq recipe, một checkpoint AFMR có `R1>49.626`, `R2>21.953` và `RL>45.895`.
...
| D | `AFMR-zero-parity` | Endpoint/smoke: copy-mass-preserving simplex, K=H0/V=H0, Wo=0 |
| E | `AFMR-tiny` | Candidate training: như D nhưng Wo calibration deterministic ~1e-3 RMS(h) |
| F | `AFMR-independent` | Capped three-way simplex có base floor, copy/semantic mass độc lập |
| G | `AFMR-KM` | K=M/V=H0, prior giảm/tắt để đo double-focus |
