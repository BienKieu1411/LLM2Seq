...
T5Gemma 2 báo tied embeddings, merged attention và cross-attention ở mọi layer; ablation chỉ đặt cross-attention ở global layers giảm khoảng 1.3 điểm trong bảng của họ.^16 Đây là cơ sở để giữ source access ở mọi layer, nhưng không phải bằng chứng AFMR sẽ thắng PubMed.
...
SDACL (Huang et al., Neurocomputing 2024) được đọc từ [bản PDF đã cung cấp](/Users/kieugiangbien/Downloads/Paper/VAI/Summarization/SDACL.pdf) và đối chiếu DOI.^20 Phương pháp dùng semantic similarity giữa summary và từng câu nguồn, chọn positive/negative theo salience và gán soft distance-aware weights. Nó phù hợp làm hướng contrastive sau này, nhưng không được đưa vào AFMR; main phải chứng minh architecture trước.
