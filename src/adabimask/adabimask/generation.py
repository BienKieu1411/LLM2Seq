"""Standalone autoregressive generation for AdaBiMask encoder-decoder models."""
...
def autoregressive_generate(
    ...
    memory, memory_mask = model.encode(input_ids, attention_mask, return_attention_mask=True)
