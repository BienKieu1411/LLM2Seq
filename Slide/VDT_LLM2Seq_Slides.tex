...
\begin{frame}{LLM2Seq: tổng quan kiến trúc}
  ...
  \smallnote{Qwen hoặc Llama đọc nguồn $\rightarrow$ adapter tạo source memory $\rightarrow$ decoder nhẹ $\rightarrow$ MTP có kiểm chứng.}
\end{frame}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.30\textwidth}
      \begin{block}{Hệ thống so sánh}
        ...
        \begin{itemize}
          \item LLM2Seq-Llama: Llama encoder
          \item LLM2Seq-Qwen: Qwen encoder
          \item T5Gemma LoRA
        \end{itemize}
        \end{minipage}
      \end{block}
