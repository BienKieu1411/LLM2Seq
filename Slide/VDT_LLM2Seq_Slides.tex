  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.30\textwidth}
      \begin{block}{Hệ thống so sánh}
        ...
        \begin{itemize}
          \item \textbf{LLM2Seq-Llama}\\[-0.15em]
          {\scriptsize LLM2Vec-Sheared-LLaMA encoder}
          \item \textbf{LLM2Seq-Qwen}\\[-0.15em]
          {\scriptsize Qwen3-Embedding-0.6B encoder}
          \item \textbf{T5Gemma baseline}\\[-0.15em]
          {\scriptsize T5Gemma-2-1B-1B LoRA}
        \end{itemize}
        \end{minipage}
      \end{block}
    \end{column}
